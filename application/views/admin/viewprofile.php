...
<div id="main-content" class="clearfix">
    ...
    <div id="page-content" class="clearfix">
        ...
        <form class="form-horizontal" method="post" action="<?=base_url('index.php/admin/viewprofile/updateprofile/'.$user_id)?>">
            <br />
            ...
            <div class="form-actions">
                ...
                &nbsp; &nbsp; &nbsp;
               <a href="<?=base_url('index.php/admin/home')?>" class="btn">
